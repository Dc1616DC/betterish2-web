...
function getFeatureRecommendations(discoveredCore, coreFeatures) {
  ...
  if (discoveredCore.includes('task-creation') && !discoveredCore.includes('morpheus-chat')) {
    recommendations.push('Ask Morpheus for seasonal maintenance tips');
  }
  
  if (discoveredCore.includes('morpheus-chat') && !discoveredCore.includes('project-breakdown')) {
  ...
  if (discoveredCore.includes('project-breakdown') && !discoveredCore.includes('step-help')) {
    recommendations.push('Get step-specific help from Morpheus');
  }
  ...
  if (!discoveredCore.length) {
    ...
    recommendations.push('Try the daily check-in with Morpheus');
  }
